...
public class AdminUserArea extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_user_area);
        ...
        ArrayAdapter<String>adapter = new ArrayAdapter<String>(AdminUserArea.this,
        ...
        regButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent regIntent=new Intent(AdminUserArea.this,RegisterActivity.class);
                AdminUserArea.this.startActivity(regIntent);
            }
        });
...
//                editor.commit();
                Intent logout=new Intent(AdminUserArea.this,MainActivity.class);
                AdminUserArea.this.startActivity(logout);
            }
        });
        loadProducts();
        ...
        switch (position) {
            case 1:
                ...
                for (int i=-1;i<ALusername.size();i++)
                {
                    ...
                    tvUname.setLayoutParams(new TableLayout.LayoutParams(TableRow.LayoutParams.WRAP_CONTENT,TableRow.LayoutParams.WRAP_CONTENT));
